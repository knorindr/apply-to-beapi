...
<!-- javascript -->
<script src="<?php echo get_template_directory_uri();?>/html/js/plugins.js"></script>
<script src="<?php echo get_template_directory_uri();?>/html/js/smooth-scroll.js"></script>
<script src="<?php echo get_template_directory_uri();?>/html/js/jquery.countTo.js"></script>
<script src="<?php echo get_template_directory_uri();?>/html/js/particles.min.js"></script>
<script src="<?php echo get_template_directory_uri();?>/html/js/main.js"></script>
</body>